...
export const PAGES = [
  ...
  { id: "portfolio", route: "/portfolio", title: "Portfolio", expect: { text: "Portfolio" } },
  { id: "cv", route: "/cv", title: "CV", expect: { text: "CV" } },
  { id: "progetti", route: "/progetti", title: "Progetti", expect: { text: "Progetti" } },
  { id: "ecommerce", route: "/ecommerce", title: "Ecommerce", expect: { text: "Shop" } },
  { id: "ecommerce-collection", route: "/ecommerce/collection", title: "Collection", expect: { selector: "main" } },
  ...
  { id: "progetti-kalaha", route: "/progetti/kalaha", title: "Kalaha page", expect: { text: "Kalaha" } },
